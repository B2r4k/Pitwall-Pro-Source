                            ...
                            <form className="w-full flex flex-col gap-4" onSubmit={(e: any) => {
                               ...
                               <div className="space-y-3">
                                  <div className="relative">
                                     <input type="email" name="email" placeholder="Email Adresi" className="w-full pl-10 pr-4 py-3.5 bg-slate-50 dark:bg-[#0a0f1c] border border-slate-200 dark:border-slate-800/80 rounded-xl focus:ring-2 focus:ring-indigo-500/50 outline-none transition-all placeholder:text-slate-400 text-sm font-medium" required />
                                  ...
                                  <div className="relative">
                                     <input type="password" name="password" placeholder="Şifre" className="w-full pl-10 pr-4 py-3.5 bg-slate-50 dark:bg-[#0a0f1c] border border-slate-200 dark:border-slate-800/80 rounded-xl focus:ring-2 focus:ring-indigo-500/50 outline-none transition-all placeholder:text-slate-400 text-sm font-medium" required />
                                     <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
...
const oldAuthUI = /<div className="flex flex-col items-center gap-6 w-full">[\s\S]*?Google ile Giriş Yap\s*<\/button>\s*<\/div>/;

c = c.replace(oldAuthUI, newAuthUI);

// Make the outer wrapper cleaner
c = c.replace(/<div className="mt-8 p-6 bg-slate-50 dark:bg-slate-900 rounded-xl border dark:border-slate-700 border-slate-200 dark:border-slate-700 w-full max-w-md">/, 
  '<div className="mt-8 w-full max-w-md bg-white dark:bg-slate-900">');

c = c.replace(/<div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border dark:border-slate-700 border-slate-200 dark:border-slate-700 shadow-sm flex flex-col items-center">/,
  '<div className="bg-white dark:bg-slate-900 p-8 rounded-3xl border dark:border-slate-800/80 border-slate-200 shadow-sm flex flex-col items-center">');
