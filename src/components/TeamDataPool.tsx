                  ...
                  <td className="py-3 text-center">
                    {item.modules?.tyre ? (
                      <div className="flex items-center justify-center gap-1">
                        <span
                          className={`px-2 py-1 rounded text-[10px] font-bold text-white ${item.modules.tyre.compound === "Soft" ? "bg-red-500" : item.modules.tyre.compound === "Medium" ? "bg-yellow-500" : item.modules.tyre.compound === "Hard" ? "bg-slate-200 text-slate-800" : item.modules.tyre.compound === "Rain" ? "bg-blue-500" : "bg-purple-500"}`}
                        >
