...
export const LoadingScreen: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen font-sans antialiased flex flex-col items-center justify-center p-4 transition-colors bg-slate-50 dark:bg-[#0a0f1c]`}>
       ...
       <div className="bg-indigo-50/50 dark:bg-indigo-900/10 border border-indigo-100 dark:border-indigo-800 p-6 rounded-2xl shadow-sm relative overflow-hidden group max-w-md w-full animate-fade-in">
         ...
         <div className="flex items-start gap-4 relative z-10">
           ...
           <div>
             <h3 className="text-lg font-bold text-indigo-950 dark:text-indigo-200 mb-1">{t('Initializing Workspace...')}</h3>
             <p className="text-indigo-800/80 dark:text-indigo-300/80 text-sm leading-relaxed">{t(LOADING_MESSAGES[messageIndex])}</p>
           </div>
         </div>
       </div>
    </div>
